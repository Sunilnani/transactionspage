              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        child: Row(
                          children: [
                            Text("All Income",style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w600),),
                            SizedBox(width: 10,),
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        Text("TOTAL INCOME",style: TextStyle(color: Color(0xFF828282),fontWeight: FontWeight.w600,fontSize: 10),),
                        SizedBox(height: 10,),
